      ...
      <div className="min-h-screen bg-white pt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#0A1628]/70 leading-relaxed text-justify">
              <p>
            ...
            {/* Our Commitment to You - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
                Our Commitment to You
              </h2>
              <p className="text-sm sm:text-base text-[#0A1628]/70 leading-relaxed mb-4 text-justify">
              ...
              <p className="text-sm sm:text-base text-[#0A1628]/70 leading-relaxed mb-3 text-justify">
                Our commitment includes:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {commitments.map((item, index) => (
                  <div key={index} className="flex items-start gap-2">
                    <CheckCircle size={16} className="flex-shrink-0 mt-0.5 text-[#1A3A6B]" />
            ...
            {/* Our Independence – Your Choice - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {independenceFactors.map((item, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#4A8BCF]" />
                    <span className="text-sm text-[#0A1628]/60">{item}</span>
                  </div>
                ))}
              </div>
              <p className="text-sm sm:text-base text-[#0A1628]/70 leading-relaxed mt-3 text-justify">
                Our objective is to help customers make informed travel decisions based on their individual requirements.
              </p>
            </div>

            {/* ARC Accreditation - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
                ARC Accreditation
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {values.map((value, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-[#F5F9FF] p-4 rounded-lg border border-[#E2E8F0] hover:border-[#4A8BCF]/30 hover:shadow-md transition-all duration-300"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="text-sm font-semibold text-[#0A1628]">{value.title}</h3>
                          <p className="text-xs text-[#0A1628]/60 mt-1 leading-relaxed text-justify">{value.description}</p>
                        </div>
                      </div>
                    </div>
                  );
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {services.map((service, index) => (
                  <div key={index} className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-[#0A1628]/60">{service}</span>
                  </div>
                ))}
              </div>
              <p className="text-xs text-[#0A1628]/40 mt-3 text-justify">
                Available services and conditions may vary depending on the airline, fare type, route, and individual reservation.
              </p>
            </div>

            {/* Technology Meets Travel Expertise - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
            ...
            {/* The Tickettoeurope.com Difference - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
            ...
            {/* Travel With Confidence - justified text */}
            ...
            {/* Our Commitment to the Future - justified text */}
            <div className="mt-10">
              <h2 className="text-xl sm:text-2xl font-bold text-[#0A1628] mb-4">
              ...
              <div className="space-y-4 text-sm sm:text-base text-[#0A1628]/70 leading-relaxed text-justify">
                ...
                <p className="text-base font-medium text-[#0A1628] mt-4 text-justify">
                  At {BRAND.name}, our goal is simple:
                </p>
                <p className="text-base font-medium italic text-[#1A3A6B] text-justify">
