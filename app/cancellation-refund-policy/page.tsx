  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "A non-refundable airline ticket does not become refundable merely because a customer requests a refund through Tickettooeurope.com."
      ],
      twoColumn: true
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "A customer should therefore not assume that every booking made through Tickettooeurope.com automatically qualifies for a 24-hour cancellation or refund."
      ]
    },
    {
      icon: Calendar,
    ...
    },
    {
      ...
      content: [
        ...
        "Customers should contact Tickettooeurope.com as soon as possible if they know they will miss a scheduled departure."
      ],
      twoColumn: true
    },
    {
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#E8F0FE]">
                ...
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Primary Decision-Maker</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Typical Result</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Customer changes plans before departure</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline fare rules + Noam Flyers Inc. processing</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Future credit, refund, exchange, or no remaining value depending on fare</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Request shortly after booking</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline policy + ticket status + agency process</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Possible reversal if eligible and timely; not automatically guaranteed</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airline cancels or significantly changes flight</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline event + applicable merchant of record</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Refund, rebooking, or applicable airline alternative</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Unused baggage, seat, or ancillary service</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline or applicable merchant of record</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Ancillary refund where required or permitted</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Medical, bereavement, or visa-related request</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline waiver review</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Possible refund or credit if waiver is approved or required</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">No-show</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Possible loss of value unless reinstatement or waiver is approved</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Agency service-fee dispute</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc.</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Review based on disclosed fee and service performed</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    },
    {
      ...
      content: [
        ...
        "Customers should contact Tickettooeurope.com promptly if:",
        "• They need to cancel",
    ...
    },
    {
      ...
      content: [
        "Tickettooeurope.com and Noam Flyers Inc. are committed to providing clear information about cancellation and refund procedures.",
        "Because Tickettooeurope.com acts as an independent travel agency, customers should understand that airline fare rules and supplier policies can differ significantly between airlines, routes, fare types, and ticket conditions.",
