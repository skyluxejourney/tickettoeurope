  ...
  const privacySections = [
    ...
    },
    {
      ...
      content: [
        ...
        "Where applicable law provides customers with rights to opt out of targeted advertising, sale, sharing, or certain forms of cross-context behavioral advertising, Tickettooeurope.com will provide applicable mechanisms for exercising those rights.",
    ...
    },
    {
      ...
      content: [
        "Tickettooeurope.com is not directed toward young children, and Noam Flyers Inc. does not knowingly seek to collect personal information from children in circumstances where such collection is prohibited by applicable law.",
    ...
    },
    {
      ...
      content: [
        "Tickettooeurope.com may use cookies, pixels, tags, logs, and similar technologies to operate the Website and understand how customers interact with our services.",
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#E8F0FE]">
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Data Category</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Examples</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Main Use</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Typical Recipients</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Identity and Contact Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Name, email, phone, address</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Booking, support, notifications</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc., airlines, processors, support providers</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Booking and Itinerary Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Routes, dates, passengers, fares, ticket references</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Fulfillment, changes, cancellations, refunds, analytics</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc., airlines, GDS/content providers</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Payment and Billing Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Billing address, payment tokens, transaction information</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Payment processing, fraud prevention, accounting</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Payment processors, risk providers, Noam Flyers Inc. financial systems</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Device and Technical Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">IP address, browser, device information, cookies</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Security, analytics, personalization</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc., analytics providers, advertising providers where permitted</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Customer-Service Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Calls, chats, recordings, support tickets</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Customer service, quality assurance, disputes, training</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc., authorized support providers</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Preference and Ancillary Data</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Meal preferences, seats, accessibility requests</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Travel fulfillment and personalization</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airlines and applicable travel-service providers</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    },
    {
      ...
      content: [
        ...
        "The most current version of this Privacy Policy will be made available on the Tickettooeurope.com Website.",
        "Where appropriate, material changes may be accompanied by an updated \"Last Updated\" date or additional notice.",
        "Your continued use of Tickettooeurope.com after an updated Privacy Policy becomes effective constitutes acknowledgment of the updated policy to the extent permitted by applicable law."
      ]
    },
    {
      icon: Phone,
      title: "17. Contact Us",
      content: [
        "If you have questions about this Privacy Policy or wish to submit a privacy-related request, please contact Noam Flyers Inc. through the contact information provided on the Tickettooeurope.com Website.",
          ...
          <div className="w-full">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-[#0A1628]/60 mt-2 text-justify">
                This Privacy Policy explains how Noam Flyers Inc. ("Company," "we," "us," or "our") collects, uses, stores, shares, retains, and otherwise handles personal information in connection with Tickettooeurope.com (the "Website"), including its booking flows, service communications, customer-support interactions, assisted-booking channels, promotions, and related travel services.
              </p>
              <p className="text-sm text-[#0A1628]/60 mt-1 text-justify">
                Tickettooeurope.com is an independent online travel agency and is not an airline. This Privacy Policy should be read together with our Cookie Policy, Fare Disclosure, Fulfillment Policy, Terms and Conditions, and any other applicable notices published on the Website.
              </p>
