  ...
  const sections = [
    {
      ...
      content: [
        ...
        "When a customer books air travel through Tickettooeurope.com, the total amount may include the airline's base fare, airline-imposed surcharges or carrier charges, government taxes, airport or passenger charges, security or inspection fees, and, where applicable, a service fee charged by Noam Flyers Inc.",
    ...
    },
    {
      ...
      content: [
        ...
        "Tickettooeurope.com does not represent an airline-imposed charge as a government tax or as a Tickettooeurope.com agency fee.",
    ...
    },
    {
      ...
      content: [
        "Noam Flyers Inc. may charge a service fee for certain services provided through Tickettooeurope.com.",
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#E8F0FE]">
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Noam Flyers Inc. Fee Type</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Draft Amount</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Online self-service air booking fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">USD 0.00 to USD 60.00 per passenger, per ticket</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Online premium-cabin or high-touch air booking fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Up to USD 120.00 per passenger</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Assisted standard booking fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">USD 15.00 to USD 150.00 per passenger, per ticket</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Assisted complex/multi-city/manual itinerary fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Up to USD 250.00 per passenger</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Assisted search variation fee — alternate dates / nearby airports on request</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Up to USD 50.00 per passenger</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Group or non-standard research fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">As quoted before payment</td>
              </tr>
            </tbody>
          </table>
    ...
    },
    {
      ...
      content: [
        "Tickettooeurope.com may provide both online self-service booking and assisted booking support.",
    ...
    },
    {
      ...
      content: [
        ...
        "Tickettooeurope.com does not guarantee that an initially displayed fare or tax amount will remain available until ticketing unless the fare has been successfully confirmed and ticketed.",
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#E8F0FE]">
                ...
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Typical Basis</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Official/Public Anchor or Treatment</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">U.S. Air Transportation Excise Tax</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Percentage of applicable taxable fare</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">7.5% where applicable</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">U.S. Domestic Segment Tax</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Per taxable domestic segment</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">USD 5.30 per applicable segment</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">U.S. International Facilities Tax</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Per qualifying international passenger</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">USD 23.40 where applicable</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">TSA September 11 Security Fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Passenger/trip basis</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">TSA-collected security fee</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Passenger Facility Charge</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Per eligible airport segment</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Up to USD 4.50 per eligible segment, subject to applicable route limits</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Other International Inspection/User Fees</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Itinerary-specific</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Varies depending on country and itinerary</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airport and Passenger Charges</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airport/route specific</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Varies</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airline-Imposed Charges</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline and fare specific</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Varies</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Noam Flyers Inc. Service Fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Agency-specific</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">As disclosed before payment</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Optional Ancillary Services</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Service selected by customer</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">As displayed before purchase</td>
              </tr>
            </tbody>
          </table>
          <p className="text-xs text-[#0A1628]/60 mt-3">
      ...
      content: (
        <div className="overflow-x-auto mt-2">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#E8F0FE]">
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Charge Type</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Typically Determined By</th>
                <th className="border border-[#E2E8F0] px-4 py-3 text-left font-semibold text-[#0A1628]">Treatment</th>
              </tr>
            </thead>
            <tbody>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airline base fare</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Forms the transportation price</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airline-imposed surcharge</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Subject to airline pricing and fare rules</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Government tax</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Government authority</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Collected as applicable to the itinerary</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Airport charge</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airport or applicable authority</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Varies by airport and itinerary</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Security fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Government/security authority</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Applies where required</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Passenger Facility Charge</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Applicable airport/authority</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Applies to eligible itineraries</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Optional baggage or seat fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Airline or service provider</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Applies only when selected or otherwise applicable</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Noam Flyers Inc. service fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc.</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Agency charge disclosed before payment</td>
              </tr>
              <tr className="hover:bg-[#F5F9FF] transition-colors">
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/80 font-medium">Post-ticketing service fee</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Noam Flyers Inc.</td>
                <td className="border border-[#E2E8F0] px-4 py-3 text-[#0A1628]/70">Applies where a qualifying after-sale service is requested</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    },
    {
      ...
      content: [
        ...
        "Noam Flyers Inc.'s own service fees are agency charges for services provided through Tickettooeurope.com and are separate from government taxes, airport charges, airline-imposed penalties, airline surcharges, fare differences, and optional ancillary charges.",
