...
export default function SearchEngine() {
  ...
  // Determine grid columns based on trip type
  const getGridCols = () => {
    if (tripType === "roundtrip") {
      return "grid-cols-1 sm:grid-cols-2 lg:grid-cols-6";
    } else {
      // For one way and multi-city - 5 columns (no return date)
      return "grid-cols-1 sm:grid-cols-2 lg:grid-cols-5";
    }
  };

  // Determine if return date should be shown
      ...
      <div className={`grid ${getGridCols()} gap-4`}>
        ...
        <div className="relative lg:col-span-1" ref={departCalendarRef}>
          ...
          <button
            ...
            className="w-full bg-[#F5F9FF] border border-[#E2E8F0] pl-10 pr-8 py-3 text-[#0A1628] text-left focus:outline-none focus:border-[#1A3A6B] focus:ring-2 focus:ring-[#1A3A6B]/20 transition-all duration-300 text-sm h-[52px] whitespace-nowrap truncate"
          >
        ...
        <div className="relative lg:col-span-1" ref={passengerRef}>
          ...
          <button
            ...
            className="w-full bg-[#F5F9FF] border border-[#E2E8F0] pl-10 pr-8 py-3 text-[#0A1628] text-left focus:outline-none focus:border-[#1A3A6B] focus:ring-2 focus:ring-[#1A3A6B]/20 transition-all duration-300 text-sm h-[52px] flex items-center whitespace-nowrap"
          >
